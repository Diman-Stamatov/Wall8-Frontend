...
function TablePagination({
  ...
  return (
    <div className="px-5 py-5 dark:bg-dark-secondary border-2  dark:border-dark-tertiary flex flex-col xs:flex-row items-center xs:justify-between rounded-b-lg         ">
      <span className="text-xs xs:text-sm dark:text-light-secondary">
        Showing {startIndex + 1} to {endIndex} of {transferCount} entries
      </span>
      <div className="inline-flex mt-2 xs:mt-0 shadow-md dark:shadow-dark-primary">
