...
function SpecialAmountsComponent({ amount }) {
  const specialPictures = new Map()
    .set(
      666,
      "https://static.wikia.nocookie.net/cartoon-characters8569/images/5/55/HIM.jpg"
    )
    ...
    .set(
      58008,
      "https://st3.depositphotos.com/1877361/16677/v/450/depositphotos_166772476-stock-illustration-abstract-drawing-of-female-breasts.jpg"
    )
    .set(
      789,
      "https://images.fineartamerica.com/images/artworkimages/mediumlarge/3/789-seven-ate-nine-funny-sarcasm-gift-idea-haselshirt.jpg"
    )
    .set(300, "https://i.imgur.com/h4eXiad.jpeg")
    .set(1984, "https://i.imgur.com/yNIcaB6.jpeg")
    .set(
      1337,
      "https://i.pinimg.com/564x/82/23/e6/8223e6f2684080d0427d1688d02875a8.jpg"
    )
  ...
  specialAmounts.forEach((number, index) => {
